    ...
    return (
        <main className="px-8 sm:px-16 py-8 xl:min-w-[40%] sm:shadow-gray-500 rounded-3xl bg-white dark:bg-gray-900">
            ...
            <form className='mb-8' onSubmit={handleSubmit}>
                ...
                <button type="submit" className={`w-full bg-red-500 text-white text-lg font-semibold px-4 py-2.5 rounded-lg hover:bg-red-600 mb-2 transition-all duration-300`}>Iniciar sesión</button>
            </form>
